...
문제를 정의한 뒤 구조로 만들고, 결과를 숫자로 검증합니다.
...
| **3** | **만들어서 검증한다** | 기획안을 문서로 오래 두지 않습니다. 프로토타입으로 구현해 내놓고, 결과를 숫자로 확인합니다. |
...
| 헬스케어 체험관 운영 | 담당자별 편차 → 표준 매뉴얼 · FAQ · 동선 재설계 | 체험 시간 **75분 → 55분 (-27%)** · 대기 인원 문제 해소 |
| 로컬 프로젝트 기획 (KT&G) | 아이디어 → 실현 가능성·예산·리스크 사전 검증 프로세스 | 목표 모집 인원 **초과 달성** · 예산 내 정상 운영 완료 |
...
| 기간 | 프로젝트 | 역할 | 소속 |
| :--- | :--- | :--- | :--- |
| 2025.07 ~ 2026.01 | 공장 혼합구역 실시간 화재 예방 관제 시스템 — 기존 AI 화재 탐지의 높은 오탐률을 멀티센서 결합으로 해결 | B2B 기획 · Backend | 스마트인재개발원 |
| 2024.01 ~ 2024.02 | 감정 교류 반려식물 — 프로토타입 제작 후 제조 원가 기반 마진율 40% 설계 | 프로젝트 총괄 | 전남대학교 만들마루 |
| 2023 | 여행 루트 공유 플랫폼 — 자율학기제 자체 기획, 상위 20% 우수 사례 선정 | 기획 · 개발 | 조선대학교 |
...
| 연도 | 자격증 | 기관 |
| :--- | :--- | :--- |
| 2026.06 | 정보처리기사 | 한국산업인력공단 |
| 2025.06 | 6시그마 GB (Green Belt) | 커리어직무센터 |
| 2024.05 | 영업관리기획실무자 2급 | 커리어직무센터 |
| 2024.04 | SQL 개발자 (SQLD) | 한국데이터산업진흥원 |
...
| 연도 | 수상 | 대회 및 기관 |
| :--- | :--- | :--- |
| 2025 | 달빛상생비즈니스모델상 (총장상) | 상생 비즈니스모델 발굴 경진대회 · 조선대학교 산학협력단 |
| 2025 | 장려상 | 제8회 전국 청년 아이디어톤 대회 · 아주대학교 지산학융복합교육원 |
| 2025 | 장려상 | 2025 입사목표기업분석 공모전 · 조선대학교 대학일자리플러스센터 |
| 2025 | 우수 멘토상 | CSU멘토단 Blooming · 조선대학교 원스톱학생상담센터 |
